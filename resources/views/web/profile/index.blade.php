                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        <a href="{{ route('profile.edit') }}" class="btn btn-primary">@lang('web.general.profile_edit')</a>
                                        <a href="{{ route('profile.change-password') }}" class="btn btn-danger">@lang('web.general.change_password')</a>
                                    </p>
                                </div>
                            </div>
                        </div>
